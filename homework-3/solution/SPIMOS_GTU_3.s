...
li $s1, 3    # procedure will be repeated two times, 3x3 = processes.
start:  addi $s1, $s1, -1
        li $t0, 3   # each will be loaded 3 times.
        li $v0, 24
        syscall
        beqz $v0, p1 # $v0 == 0
        addi $v0, $v0, -1
